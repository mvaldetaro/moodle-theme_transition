...
class theme_transition_core_renderer extends core_renderer {
    ...
    public function navbar() {
        ...
        return $title . "<ol class=\"breadcrumb\">$list_items</ol>";
    }

    /*
     * Overriding the page_heading_button function ensures the custom menu is
     */
    ...
    public function block_header(block_contents $bc) {
        ...
        if ($title || $controlshtml) {
            $output .= html_writer::tag('div', html_writer::tag('div', html_writer::tag('div', '', array('class'=>'block_action opa')). $title . $controlshtml, array('class' => 'title')), array('class' => 'header'));
        }
        return $output;
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_transition_core_renderer_maintenance extends core_renderer_maintenance {
    /**
